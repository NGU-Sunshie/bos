				...
				.datagrid(
						{
							...
							rownumbers : true,
							striped : true,
							url : "subareaAction_findListByDecidedzoneId.action?decidedzoneId="
									+ data.id,
							columns : [ [ {
								field : 'id',
								title : '分拣编号',
		...
		$('#association_customer').datagrid(
				{
					...
					rownumbers : true,
					striped : true,
					url : "decidedzoneAction_findListHasAssociation.action?id="
							+ data.id,
					columns : [ [ {
						field : 'id',
						title : '客户编号',
...
<body class="easyui-layout" style="visibility: hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow"
		...
		<div style="overflow: auto; padding: 5px;" border="false">
			<form id="addDecidedzoneForm" action="decidedzoneAction_add.action"
				method="post">
				...
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						...
						<td><input type="button" value="》》" id="toRight"><br />
							<input type="button" value="《《" id="toLeft"> <script
