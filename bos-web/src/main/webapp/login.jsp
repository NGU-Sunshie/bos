...
<body>
				...
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							style="margin-left:0px;margin-top:-40px;width:55px;">
							<input id="loginform:codeInput" class="loginFormTdIpt" type="text"
								name="checkcode" title="请输入验证码"  maxlength="4">
					...
					<div align="center" style="color: red;margin-top: 10px;"><s:actionerror/></div>
				</form>
			</div>
		</div>
	</div>
	<div
		...
		<span style="color: #488ED5;">Powered By xxx.cn</span><span
